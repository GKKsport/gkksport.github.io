...
const PRECACHE = 'GKKv3.0.2';
const RUNTIME = 'GKKv3.0.2';
...
//1.2.3 - Infographic
//2.0.0 - Zuipen in de buurt!
//2.0.1 - Zuipen in de buurt update (jquery)
//2.0.2 - Eten en shoppen anvulling
//2.0.3 - offline notificatie
//2.0.4 - css-tweaks
//2.0.6 - Triathlon-calc update (eigen afstand)
//2.0.7 - Triathlon-countdown op tussenstandpagina
//2.0.8 - Chat
//2.1.0 - Oefeningen update
//2.1.1 - Snelheidsoefeningen toegevoegd
//3.0.0 - Wielerkalender
//3.0.1 - Push messages wielerkalender
